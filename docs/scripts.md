...
| `fm-shipshape.sh`        | Fast-forward the captain's live repos (dotfiles, vault) to main, re-stow dotfiles symlinks to that main, then run fm-update.sh for firstmate + secondmates |
